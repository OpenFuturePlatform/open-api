        ...
        <div>
            ...
            <div className="menu-landing-page menu-main" id="burger">
                <a href="/oauth2/authorization/google">
                    <Button color="google plus">
                        <Icon style={{color: '#FFFFFF'}} name="google plus"/>{' '}
                        Login with Google
                    </Button>
                </a>
            </div>
                    ...
                    <div className="soc-links">
                        ...
                        <div>
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                href="http://go.openfuture.io/xc9x"
                            >
                                Telegram
                            </a>
                        </div>
            ...
            <section className="header-landing-page">
                ...
                <div className="media-coverage">
                    <img
                        src="img/svg/media-coverage.svg"
                        alt="img"
                        className=""
                    />
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://prkit.co/openplatform/articles"
            ...
            <section className="description">
                ...
                <div className="description-info">
                    <div className="item">
                        <p className="fs-36 lh-48 bold color-blue title">
                            PAYMENT INFRASTRUCTURE
                        </p>
                        <p className="fs-18 lh-36">
                            Filling the gap of application payment
                            infrastructure required for applications to
                            communicate on-chain payments with their application
                            backend.
                        </p>
                    </div>
                    <div className="item">
                        ...
                        <p className="fs-18 lh-36">
                            All in one. Accept, transfer payment data, verify,
                            authorize goods for applications, both ways on and
                            off blockchains all with minimal blockchain
                            knowledge.
                        </p>
                    </div>
                </div>
            ...
            <section className="structure">
                <div className="card-area c1">
                    <div className="card">
                        ...
                        <p className="fs-24 lh-32 bold color-blue title">
                            COMPONENTS
                        </p>
                        <p className="fs-14 lh-24">
                            Providing the missing components<br/>
                            applications need to accept cryptocurrency<br/> and
                            the associated payment data
                        </p>
                    </div>
                </div>
                <div className="card-area c2">
                    <div className="card">
                        ...
                        <p className="fs-14 lh-24">
                            Deploy an application′s payment <br/>scheme on any
                            blockchain<br/> and incorporate any payment scheme
                        </p>
                    </div>
                </div>
                ...
                <div className="card-area c4">
                    <div className="card">
                        ...
                        <p className="fs-14 lh-24">
                            Operate beyond the limits of<br/> a cryptocurrency
                            wallet
                        </p>
                    </div>
                </div>
            ...
            <section className="intuitive">
                ...
                <img
                    className="intuitive-back"
                    src="img/svg/intuitive-back.svg"
                    alt="back"
                />
                <div className="intuitive-content">
                    <p className="fs-36 bold color-blue title">
                        THE FIRST "DEVELOPER WALLET"
                    </p>
                    <p className="lh-36">
                        OPEN Takes the complexities of the blockchain and
                        simplifies<br/>
                        them for those looking to integrate blockchain with
                        their applications:
                    </p>
                    <div className="item">
                        <p className="fs-14 lh-24">
                            The first bridge between blockchain and databases
                            required for sophisticated applications.
                        </p>
                    </div>
                    <div className="item">
                        <p className="fs-14 lh-24">
                            Reducing the amount of solidity/blockchain knowledge
                            required.
                        </p>
                    </div>
                    <div className="item">
                        <p className="fs-14 lh-24">
                            Enabling developers to develop in any language using
                            OPEN API.
                        </p>
                    </div>
                </div>
            ...
            <section className="application">
                ...
                <div className="first-text">
                    <p className="fs-36 lh-48 bold color-blue">
                        HOW OPEN TECHNOLOGIES WORK
                    </p>
                    <p className="fs-18 lh-36">
                        <strong>OPEN</strong> provides the application rails to
                        connect all on-chain<br/>
                        payments and the complimenting proof-of-goods into<br/>
                        any application′s backend.
                    </p>
                    <p className="fs-18 lh-36">
                        Think of it is as the first developer wallet all
                        applications require <br/>
                        with an accompanying API to enable any developer to use{' '}
                        <br/>
                        <strong>OPEN</strong>
                ...
                <img
                    src="img/svg/app-architecture.svg"
                    className="info-img"
                    alt="img"
                />
                <img
                    src="img/svg/app-architecture-mob.svg"
                    className="info-img-mob"
                    alt="img"
                />
                <div className="second-text">
                    <p className="fs-18 lh-36">
                        The <strong>OPEN SCAFFOLDS</strong> and{' '}
                        <strong>OPEN STATE</strong> enable application<br/>
                        to interoperate with on-chain components.
                    </p>
                    <p className="fs-18 lh-36">
                        The <strong>OPEN API</strong> enables on-chain
                        interactions to sync with<br/>
                        an application′s database. Record and update payments,<br/>
                        user data, user access, etc. on and off the blockchain
                        all at once.
                    </p>
                </div>
            </section>
            <section className="open-token">
                ...
                <p className="fs-36 lh-48 bold color-blue center title">
                    OPEN TOKEN
                </p>
                <p className="lh-36 center ">
                    <strong>OPEN TOKEN</strong> activates Scaffolds to allow
                    application developers to accept payments
                </p>
            ...
            <footer>
                ...
                <div className="footer-column">
                    ...
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://medium.com/@theOPENPlatform"
                    >
                        Medium
                    </a>
                </div>
                ...
                <div className="footer-column">
                    ...
                    <a
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://open.crisp.help/en-us/?1515552127224"
                    >
                        Help Desk
                    </a>
                </div>
