...
import {convertCurrencies, deployEthereumContract} from '../actions/deploy-contract';
...
class EthereumScaffoldForm extends Component {
  ...
  handleOnSubmit = async e => {
    ...
    e.preventDefault();
    try {
      const contractAddress = await actions.deployEthereumContract(formValues);
...
EthereumScaffoldForm = reduxForm({
  validate,
  warn,
...
})(EthereumScaffoldForm);

export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(EthereumScaffoldForm));
