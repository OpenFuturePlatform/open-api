...
import {topUpTokenBalance} from '../actions/ethereum-scaffold-activation';
...
const EthereumScaffoldTopUpTokensComponent = ({ children, topUpError, ...props }) => (
  <div>
    <span>
...
export const EthereumScaffoldTopUpTokens = connect(
  mapStateToProps,
  mapDispatchToProps
)(withVisible(withSaving(EthereumScaffoldTopUpTokensComponent)));
