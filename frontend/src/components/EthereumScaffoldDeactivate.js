...
export const EthereumScaffoldDeactivateComponent = ({ developerAddress, ...props }) => (
  <span>
...
export const EthereumScaffoldDeactivate = withVisible(withSaving(EthereumScaffoldDeactivateComponent));
